...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/article/list?category.id=${article.category.id}">文章列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="article" action="${ctx}/cms/article/list" method="post" class="breadcrumb form-search">
